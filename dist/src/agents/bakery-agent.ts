...
export class BakeryAssistantAgent extends Agent<Env, BakeryState> {
  ...
  // Product catalog (now fetchable from backend)
  private productCatalog = [
    { id: 1, name: 'Heritage Mooncake', category: 'mooncakes', price: 450, image: 'images/mooncake-1.jpg', description: 'Rich, nutty flavor with golden crust', tags: ['mooncake', 'classic', 'heritage'] },
    { id: 2, name: 'Thai Tea Cake', category: 'cakes', price: 380, image: 'images/cake-1.jpg', description: 'Fragrant Thai tea with creamy texture', tags: ['cake', 'thai tea', 'popular'] },
    { id: 3, name: 'Pandan Custard', category: 'pastries', price: 120, image: 'images/pastry-1.jpg', description: 'Fragrant pandan with creamy custard', tags: ['pandan', 'custard', 'pastry', 'popular'] },
    { id: 4, name: 'Black Sesame Roll', category: 'pastries', price: 95, image: 'images/cookie-1.jpg', description: 'Rich black sesame filling', tags: ['sesame', 'black', 'roll', 'specialty'] },
    { id: 5, name: 'Salted Egg Pastry', category: 'pastries', price: 150, image: 'images/pastry-2.jpg', description: 'Traditional salted egg yolk pastry', tags: ['salted', 'egg', 'pastry', 'traditional'] },
  ];

  // Fallback product catalog for when backend is unavailable
  private fallbackProductCatalog = [
